...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../amppartners/SouthernUtahUniversitySherrattLibrary.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../amppartners/SouthernUtahUniversitySherrattLibrary.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../amppartner/SouthernUtahUniversitySherrattLibrary.php">
<!-- Title -->
<title> Southern Utah University - Sherratt Library </title>
<?php include("../includes/partnermenuhead.php");?>
<div class="imageAndDes">
<!-- Image -->
<img src="../images/partner_images/partner123.jpg" alt=""width="341" height="245"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
