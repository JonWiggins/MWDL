...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../amppartners/UniversityofNevadaLasVegasUniversityLibraries.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../amppartners/UniversityofNevadaLasVegasUniversityLibraries.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../amppartner/UniversityofNevadaLasVegasUniversityLibraries.php">
<!-- Title -->
<title> University of Nevada, Las Vegas, University Libraries </title>
<?php include("../includes/partnermenuhead.php");?>
<div class="imageAndDes">
<!-- Image -->
<img src="../images/partner_images/partner104.jpg" alt="Lied Library" width="371" height="212"align="right" style="max-width:250px; height:auto; margin: 3%; display:block; ">
<!-- Image Description -->
Lied Library
</div>
<!-- Partner #104 -->
...
<!-- Website Link -->
<h6><a href="http://digital.library.unlv.edu/" target="_blank">University of Nevada, Las Vegas, University Libraries Website</a></h6>
<p></p>
<!-- Article Text -->
<p>
