...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../amppartners/BrighamYoungUniversityHaroldBLeeLibrary.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../amppartners/BrighamYoungUniversityHaroldBLeeLibrary.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../amppartner/BrighamYoungUniversityHaroldBLeeLibrary.php">
<!-- Title -->
<title> Brigham Young University - Harold B. Lee Library </title>
<?php include("../includes/partnermenuhead.php");?>
<div class="imageAndDes">
<!-- Image -->
<img src="../images/partner_images/partner102.jpg" alt=""width="377" height="268"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
