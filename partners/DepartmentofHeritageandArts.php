...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../amppartners/DepartmentofHeritageandArts.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../amppartners/DepartmentofHeritageandArts.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../amppartner/DepartmentofHeritageandArts.php">
<!-- Title -->
<title> Department of Heritage and Arts </title>
<?php include("../includes/partnermenuhead.php");?>
<div class="imageAndDes">
<!-- Image -->
<img src="../images/partner_images/partner119.jpg" alt=""width="366" height="286"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
...
<!-- Article Text -->
<p><br/><p>This extensive set of unique collections from the Department of Heritage and Arts contains tens of thousands of photographs depicting important parts of Utah history. We are located in the 1910 Rio Grande Depot in Salt Lake City.</p><br/></p>
<hr>
