...
<meta name="description" content="Utah Valley University Library, a Partner of the MWDL">
<?php include("../includes/linkImports.php");?>
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../amppartners/UtahValleyUniversityLibrary.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../amppartners/UtahValleyUniversityLibrary.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../amppartner/UtahValleyUniversityLibrary.php">
<!-- Title -->
<title> Utah Valley University Library </title>
<?php include("../includes/partnermenuhead.php");?>
<div class="imageAndDes">
<!-- Image -->
<img src="../images/partner_images/partner121.jpg" alt=""width="361" height="240"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
...
<li><a href = "../collections/UtahValleyUniversityStudentThesesCollection.php">Utah Valley University Student Theses Collection</a></li>
...
<li><a href = "../collections/UtahFireandRescueAcademy.php">Utah Fire and Rescue Academy</a></li>
<li><a href = "../collections/UtahValleyUniversityEncodedArchivalDescriptionEADFindingAids.php">Utah Valley University Encoded Archival Description (EAD) Finding Aids</a></li>
