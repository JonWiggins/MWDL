...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../amppartners/ProvoUTCity.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../amppartners/ProvoUTCity.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../amppartner/ProvoUTCity.php">
<!-- Title -->
<title> Provo (UT) City </title>
<?php include("../includes/partnermenuhead.php");?>
<div class="imageAndDes">
<!-- Image -->
<imageName src="../images/partner_images/partner138.jpg" alt=""width="354" height="265"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
