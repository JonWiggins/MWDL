...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../amppartners/UtahStateHistoricalSociety.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../amppartners/UtahStateHistoricalSociety.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../amppartner/UtahStateHistoricalSociety.php">
<!-- Title -->
<title> Utah State Historical Society </title>
<?php include("../includes/partnermenuhead.php");?>
<div class="imageAndDes">
<!-- Image -->
<img src="../images/partner_images/partner119.jpg" alt="Rio Grande Depot" width="366" height="286"align="right" style="max-width:250px; height:auto; margin: 3%; display:block; ">
<!-- Image Description -->
Rio Grande Depot, 1912
</div>
<!-- Partner #119 -->
<!-- Partner Name -->
<h3>Utah State Historical Society</h3>
<!-- Website Link -->
<h6><a href="http://history.utah.gov/" target="_blank">Utah State Historical Society Website</a></h6>
<p></p>
<!-- Article Text -->
<p>
<p>This extensive set of unique collections from the Utah State Historical Society contains tens of thousands of photographs depicting important parts of Utah history. We are located in the 1910 Rio Grande Depot in Salt Lake City.</p>


</p>
<hr>
<h6>
<a href="http://utah-primoprod.hosted.exlibrisgroup.com/primo_library/libweb/action/search.do?tab=default_tab&mode=Advanced&scp.scps=scope:(mw)&vid=MWDL&indx=1&dum=true&srt=rank&frbg=&fn=search&ct=search&vl(1UI1)=exact&vl(35820410UI1)=lsr12&vl(freeText1)=Utah+State+Historical+Society">Browse all records from Utah State Historical Society</a></p></h6>
...
<li><a href = "../collections/UtahStateHistoricalSocietyClassifiedPhotographCollection.php">Utah State Historical Society Classified Photograph Collection</a></li>
