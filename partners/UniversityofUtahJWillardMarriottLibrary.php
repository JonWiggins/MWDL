...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../amppartners/UniversityofUtahJWillardMarriottLibrary.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../amppartners/UniversityofUtahJWillardMarriottLibrary.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../amppartner/UniversityofUtahJWillardMarriottLibrary.php">
<!-- Title -->
<title> University of Utah - J. Willard Marriott Library </title>
<?php include("../includes/partnermenuhead.php");?>
<div class="imageAndDes">
<!-- Image -->
<imageName src="../images/partner_images/partner101.jpg" alt=""width="364" height="190"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
