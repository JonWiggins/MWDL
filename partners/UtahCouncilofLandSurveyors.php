...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../amppartners/UtahCouncilofLandSurveyors.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../amppartners/UtahCouncilofLandSurveyors.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../amppartner/UtahCouncilofLandSurveyors.php">
<!-- Title -->
<title> Utah Council of Land Surveyors </title>
<?php include("../includes/partnermenuhead.php");?>
<div class="imageAndDes">
<!-- Image -->
<imageName src="../images/partner_images/partner137.jpg" alt=""width="226" height="228"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
