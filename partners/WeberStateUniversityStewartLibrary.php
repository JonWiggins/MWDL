...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../amppartners/WeberStateUniversityStewartLibrary.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../amppartners/WeberStateUniversityStewartLibrary.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../amppartner/WeberStateUniversityStewartLibrary.php">
<!-- Title -->
<title> Weber State University - Stewart Library </title>
<?php include("../includes/partnermenuhead.php");?>
<div class="imageAndDes">
<!-- Image -->
<imageName src="../images/partner_images/partner106.jpg" alt=""width="362" height="271"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
