...
<!-- Image Description -->
<a href="http://content.lib.utah.edu/cdm/ref/collection/EHSL-FBWNOC/id/226" target="_blank">Invasion of the Nerve Snatchers, Part III (Coronal T2 Annotated)<br> </a>
</div>
<!-- Collection Title-->
...
<a href=" http://utah-primoprod.hosted.exlibrisgroup.com/primo_library/libweb/action/search.do?tab=default_tab&mode=Advanced&scp.scps=scope:(mw)&vid=MWDL&indx=1&dum=true&srt=rank&frbg=&fn=search&ct=search&vl(1UI1)=exact&vl(35820410UI1)=lsr13&vl(freeText1)=Neuro-Ophthalmology:+Frank+B.+Walsh+Society+Archives">Browse all records in Neuro-Ophthalmology: Frank B. Walsh Society Archives</a></p>
</h6>
<p></p>
</div>
</div>
