...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/UtahLegislatureLittleHooverCommission19651966.php&t=Utah Legislature. Little Hoover Commission%comma% 1965-1966"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/UtahLegislatureLittleHooverCommission19651966.php&via=@MountainWestDL&text=Utah Legislature. Little Hoover Commission%comma% 1965-1966"
...
<!-- Collection Title-->
<h4>Utah Legislature. Little Hoover Commission%comma% 1965-1966</h4>
