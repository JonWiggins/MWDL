...
<meta name="description" content="Sheep Industry of Northern Nevada, a MWDL collection, presented by University of Nevada, Reno, University Libraries">
<?php include ("../includes/collectionlinkimports.php");?>
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/SheepIndustryofNorthernNevada.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/SheepIndustryofNorthernNevada.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/SheepIndustryofNorthernNevada.php">
<!-- Collection #1830 -->
<!-- Collection Title -->
<title>Sheep Industry of Northern Nevada</title>
<?php include("../includes/collectionmenuhead.php");?>
 
<!-- Share Links -->
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/SheepIndustryofNorthernNevada.php&t=Sheep Industry of Northern Nevada"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/SheepIndustryofNorthernNevada.php&via=@MountainWestDL&text=Sheep Industry of Northern Nevada"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/SheepIndustryofNorthernNevada.php"
