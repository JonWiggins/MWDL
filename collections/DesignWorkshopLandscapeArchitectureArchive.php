...
<!-- Image Description -->
<a href="http://digital.lib.usu.edu/cdm/singleitem/collection/Design/id/34" target="_blank">Mountains in Kananaskis Country, Alberta<br> </a>
</div>
<!-- Collection Title-->
...
<a href=" http://utah-primoprod.hosted.exlibrisgroup.com/primo_library/libweb/action/search.do?tab=default_tab&mode=Advanced&scp.scps=scope:(mw)&vid=MWDL&indx=1&dum=true&srt=rank&frbg=&fn=search&ct=search&vl(1UI1)=exact&vl(35820410UI1)=lsr13&vl(freeText1)=Design+Workshop+Landscape+Architecture+Archive">Browse all records in Design Workshop Landscape Architecture Archive</a></p>
</h6>
<p></p>
</div>
</div>
