...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/UniversityofUtahThesesandDissertations3.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/UniversityofUtahThesesandDissertations3.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/UniversityofUtahThesesandDissertations3.php">
<!-- Collection #1617 -->
<!-- Collection Title -->
...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/UniversityofUtahThesesandDissertations3.php&t=University of Utah Theses and Dissertations 3"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/UniversityofUtahThesesandDissertations3.php&via=@MountainWestDL&text=University of Utah Theses and Dissertations 3"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/UniversityofUtahThesesandDissertations3.php"
...
This collection is #3 of 3 collections. For the rest of the items, see <a href="1249.php">University of Utah Theses and Dissertations 1</a> or <a href="1250.php">University of Utah Theses and Dissertations 2</a></p>
The Theses and Dissertations collection includes selected dissertations, masters theses and projects, and undergraduate honors theses from University of Utah graduates. Some theses and dissertations are viewable in the campus libraries only.</p>
 <a href="http://content.lib.utah.edu/cdm/ref/collection/etd3/id/321" target="_blank">The role of the microprocessor in the end of the Cold War<br> </a>University of Utah</p>
</p>
<hr>
<h6>
<!-- Browse Link -->
