...
<!-- Image (if any)-->
<img src="../images/collection_images/collection2164.jpg" alt="
...
<!-- Image Description -->
<a href="http://digital.lib.usu.edu/cdm/singleitem/collection/p16944coll7/id/79/rec/127 " target="_blank"> Horse Teams working on the old reservoir (1871-1946)</a>
</div>
<!-- Collection Title-->
...
<a href=" http://utah-primoprod.hosted.exlibrisgroup.com/primo_library/libweb/action/search.do?tab=default_tab&mode=Advanced&scp.scps=scope:(mw)&vid=MWDL&indx=1&dum=true&srt=rank&frbg=&fn=search&ct=search&vl(1UI1)=exact&vl(35820410UI1)=lsr13&vl(freeText1)=Newton+and+Cache+Junction+(UT)+Historical+Collection">Browse all records in Newton and Cache Junction (UT) Historical Collection</a></p>
</h6>
<p></p>
</div>
</div>
