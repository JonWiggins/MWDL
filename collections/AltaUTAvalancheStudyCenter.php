...
<!-- Image Description -->
<a href="http://content.lib.utah.edu/cdm4/document.php?CISOROOT=/altaav&CISOPTR=784&REC=20" target="_blank">Avalanche Accidents Report<br> </a>
</div>
<!-- Collection Title-->
...
<a href=" http://utah-primoprod.hosted.exlibrisgroup.com/primo_library/libweb/action/search.do?tab=default_tab&mode=Advanced&scp.scps=scope:(mw)&vid=MWDL&indx=1&dum=true&srt=rank&frbg=&fn=search&ct=search&vl(1UI1)=exact&vl(35820410UI1)=lsr13&vl(freeText1)=Alta+(UT)+Avalanche+Study+Center">Browse all records in Alta (UT) Avalanche Study Center</a></p>
</h6>
<p></p>
</div>
</div>
