...
<meta name="description" content="Weber State University, Stewart Library, Special Collections Encoded Archival Description (EAD) Finding Aids">
<?php include ("../includes/collectionlinkimports.php");?>
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/WeberStateUniversityStewartLibrarySpecialCollectionsEncodedArchivalDescriptionEADFindingAids.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/WeberStateUniversityStewartLibrarySpecialCollectionsEncodedArchivalDescriptionEADFindingAids.php">
...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/WeberStateUniversityStewartLibrarySpecialCollectionsEncodedArchivalDescriptionEADFindingAids.php"
...
<!-- Image (if any)-->
<img src="../images/collection_images/collection1272.jpg" alt="Penlight-cover Test"width="120" height="90"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
Penlight-cover Test
</div>
<!-- Collection Title-->
...
</p><br/>This is a collection of Encoded Archival Description (EAD) pages for Weber State University.</p><br/>
<hr>
<h6>
<!-- Browse Link -->
