...
<meta name="description" content="Brigham Young University Theses and Dissertations, a MWDL collection, presented by Brigham Young University - Harold B. Lee Library">
<?php include ("../includes/collectionlinkimports.php");?>
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/BrighamYoungUniversityThesesandDissertations.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/BrighamYoungUniversityThesesandDissertations.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/BrighamYoungUniversityThesesandDissertations.php">
<!-- Collection #1067 -->
<!-- Collection Title -->
...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/BrighamYoungUniversityThesesandDissertations.php&t=Brigham Young University Theses and Dissertations"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/BrighamYoungUniversityThesesandDissertations.php&via=@MountainWestDL&text=Brigham Young University Theses and Dissertations"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/BrighamYoungUniversityThesesandDissertations.php"
