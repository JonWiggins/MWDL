...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/LatinoLatinaVoices.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/LatinoLatinaVoices.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/LatinoLatinaVoices.php">
<!-- Collection #1229 -->
<!-- Collection Title -->
<title>Latino/Latina Voices</title>
<?php include("../includes/collectionmenuhead.php");?>
 
<!-- Share Links -->
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/LatinoLatinaVoices.php&t=Latino/Latina Voices"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/LatinoLatinaVoices.php&via=@MountainWestDL&text=Latino/Latina Voices"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/LatinoLatinaVoices.php"
