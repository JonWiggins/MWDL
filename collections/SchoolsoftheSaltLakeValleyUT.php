...
<!-- Image Description -->
<a href="http://content.lib.utah.edu/cdm/ref/collection/ushs-school/id/81" target="_blank">Wasatch School<br> </a>
</div>
<!-- Collection Title-->
...
<a href=" http://utah-primoprod.hosted.exlibrisgroup.com/primo_library/libweb/action/search.do?tab=default_tab&mode=Advanced&scp.scps=scope:(mw)&vid=MWDL&indx=1&dum=true&srt=rank&frbg=&fn=search&ct=search&vl(1UI1)=exact&vl(35820410UI1)=lsr13&vl(freeText1)=Schools+of+the+Salt+Lake+Valley+(UT)">Browse all records in Schools of the Salt Lake Valley (UT)</a></p>
</h6>
<p></p>
</div>
</div>
