...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/LaiePlantationandCommunityPhotoCollection18791965.php&t=Laie Plantation and Community Photo Collection%comma% 1879-1965"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/LaiePlantationandCommunityPhotoCollection18791965.php&via=@MountainWestDL&text=Laie Plantation and Community Photo Collection%comma% 1879-1965"
...
<!-- Collection Title-->
<h4>Laie Plantation and Community Photo Collection%comma% 1879-1965</h4>
