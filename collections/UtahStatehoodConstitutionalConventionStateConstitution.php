...
<!-- Image Description -->
<a href="http://images.archives.utah.gov/cdm4/document.php?CISOROOT=/3214&CISOPTR=75&REC=1" target="_blank">State Constitution<br> </a>
</div>
<!-- Collection Title-->
...
<a href=" http://utah-primoprod.hosted.exlibrisgroup.com/primo_library/libweb/action/search.do?tab=default_tab&mode=Advanced&scp.scps=scope:(mw)&vid=MWDL&indx=1&dum=true&srt=rank&frbg=&fn=search&ct=search&vl(1UI1)=exact&vl(35820410UI1)=lsr13&vl(freeText1)=Utah+Statehood+Constitutional+Convention+State+Constitution">Browse all records in Utah Statehood Constitutional Convention State Constitution</a></p>
</h6>
<p></p>
</div>
</div>
