...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/DaughtersoftheUtahPioneersSpringvilleUT.php&t=Daughters of the Utah Pioneers%comma% Springville (UT)"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/DaughtersoftheUtahPioneersSpringvilleUT.php&via=@MountainWestDL&text=Daughters of the Utah Pioneers%comma% Springville (UT)"
...
<!-- Collection Title-->
<h4>Daughters of the Utah Pioneers%comma% Springville (UT)</h4>
