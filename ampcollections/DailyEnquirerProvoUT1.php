...
<link rel="canonical" href="../collections/DailyEnquirerProvoUT1.php">
<?php include("../includes/ampstyle.php");?>
 
<!-- Collection Title -->
<h3>Daily Enquirer (Provo%comma% UT) 1</h3>
<!-- Collection Publisher -->
<h6> Published by <a href="../partners/BrighamYoungUniversityHaroldBLeeLibrary.php">Brigham Young University - Harold B. Lee Library</a></h6>
<!-- Collection Image -->
<div class=amp-img-fill>
<amp-img src="../images/collection_images/alt="Daily Enquirer (Provo%comma% UT) 2 collection"width="335" height ="337"  layout = "responsive"></amp-img>
</div>
<!-- Image Description -->
