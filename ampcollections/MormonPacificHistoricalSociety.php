...
<link rel="canonical" href="../collections/MormonPacificHistoricalSociety.php">
<?php include("../includes/ampstyle.php");?>
 
<!-- Collection Title -->
<h3>Mormon Pacific Historical Society</h3>
<!-- Collection Publisher -->
<h6> Published by <a href="../partners/BrighamYoungUniversityHawaii.php">Brigham Young University-Hawaii</a></h6>
<!-- Collection Image -->
<div class=amp-img-fill>
<amp-img src="../images/collection_images/collection1082.jpg"alt="No. 22 Mormon Pacific Historical Society"width="388" height ="502"  layout = "responsive"></amp-img>
</div>
<!-- Image Description -->
